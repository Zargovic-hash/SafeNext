        ...
        >
          ...
          >
            <div className="text-center">
              ...
              <CardDescription>
                Explorez les audits par conformité, priorité et faisabilité
              </CardDescription>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-4">
                <CollapsibleTable 
                  audits={conformesAudits} 
                  title="Audits Conformes" 
                  icon={<CheckCircleIcon className="h-4 w-4" />}
                  color="success"
                />
                <CollapsibleTable 
                  audits={nonConformesAudits} 
                  title="Audits Non Conformes" 
                  icon={<XCircleIcon className="h-4 w-4" />}
                  color="error"
                />
                <CollapsibleTable 
                  audits={nonApplicablesAudits} 
                  title="Audits Non Applicables" 
              ...
              <div className="space-y-4">
                <CollapsibleTable 
                  audits={critiqueAudits} 
                  title="Priorité Critiques" 
                  icon={<AlertCircleIcon className="h-4 w-4" />}
                  color="error"
                />
                <CollapsibleTable 
                  audits={eleveeAudits} 
                  title="Priorité Élevés" 
                  icon={<ClockIcon className="h-4 w-4" />}
                  color="warning"
                />
                <CollapsibleTable 
                  audits={facileAudits} 
                  title="Faisabilité Faciles" 
                  icon={<CheckCircleIcon className="h-4 w-4" />}
                  color="success"
                />
                <CollapsibleTable 
                  audits={difficileAudits} 
                  title="Faisabilité Difficiles" 
                  icon={<XCircleIcon className="h-4 w-4" />}
                  color="error"
                />
              </div>
